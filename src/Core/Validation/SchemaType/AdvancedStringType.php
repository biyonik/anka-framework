...
namespace Framework\Core\Validation\SchemaType;

use Framework\Core\Validation\Traits\AdvancedStringValidationTrait;
/*
...
class AdvancedStringType extends StringType
{
     ...
     * @param \Framework\Validation\ValidationResult $result Doğrulama sonucu
     */
    public function validate(string $field, mixed $value, \Framework\Validation\ValidationResult $result): void
    {
